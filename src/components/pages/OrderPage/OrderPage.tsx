...
const OrderPage = () => {
  ...
  const [paymentLoadingOrderId, setPaymentLoadingOrderId] = useState<
    string | null
  >(null);
    ...
    switch (tab) {
      ...
      case "to-ship":
        return orderList.filter(
          (order) =>
            order.payment.status === "COMPLETED" && order.status === "PENDING",
        );
      case "to-receive":
                      ...
                      {order.orderItems.map((item) => (
                        ...
                        >
                          ...
                          <div className="flex-1 min-w-0">
                            <h4 className="font-medium text-sm md:text-base line-clamp-2 mb-1">
                              {item.product.name}
                            </h4>
